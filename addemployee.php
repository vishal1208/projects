                              ...
                              <div class="panel-body">
                                  <form role="form">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <input type="text" name="txtei" class="form-control" id="exampleInputText11" placeholder="EmployeeID"  />
                                      </div>
                                      
                                      <div class="form-group">
                                          <label for="exampleInputText1">Employee Name</label>
                                          <input type="text" name="txten" class="form-control" id="exampleInputText11" placeholder="Employee Name"  />
                                      </div>
                                      
                                      <div class="form-group">
                                          <label for="exampleInputText1">Employee User Name</label>
                                          <input type="text" name="txteun" class="form-control" id="exampleInputText11" placeholder="Employee User Name"  />
                                      </div>
                                      ...
                                      <textarea style="height:150px ;  resize: vertical;  " name="txta" class="form-control" id="exampleInputText1" placeholder="Address"  ></textarea>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="txtd" class="form-control" id="exampleInputText11" placeholder="Designation"  />
                                      </div>
                                      
                                       <div class="form-group">
                                          <label for="exampleInputText1">Outlet</label>
                                          <input type="text" name="txto" class="form-control" id="exampleInputText11" placeholder="Outlet"  />
                                      </div>
                                      
                                      
                                       <div class="form-group">
                                          <label for="exampleInputText1">Salary</label>
                                          <input type="text" name="txts" class="form-control" id="exampleInputText11" placeholder="Salary"  />
                                      </div>
...
if(isset($_GET['sbt']))
{
    ...
    $qry="INSERT INTO employee(emp_id, emp_name, emp_user_name, emp_pass, address, designation, outlet, salary, contact_no, date_of_birth) VALUES ($ei,'$en','$eun','$p','$a','$d','$o',$s,'$c','$dob')";
