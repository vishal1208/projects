...
$conn= @mysqli_connect($host,$user,$pass,$db) or die("Can't connect to database");
 ...
 if(isset($_SESSION['username']))
                {
    $qry="Select * from careers order by request_no";
                       ...
                       <div class="panel-body table-responsive">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        while( $row=mysqli_fetch_row($rs))
                                        {
                                            ...
                                            {
                                              if($i==$count)
                                                echo "<td><form action='updatecareer.php' > <input type='hidden' name='update' value='$row[0]' />   <input type='submit'  value='Update' class='active btn btn-info' /> </form>  </td>";

                                            else if($i==$count+1)
                                                echo "<td> <form action='deletecareer.php'  > <input type='hidden' name='delete' value='$row[0]' /><input type='submit' value='Delete' class='active btn btn-info' /></form> </td>";
