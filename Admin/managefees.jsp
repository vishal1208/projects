<%-- 
    Document   : managefees
    Created on : Jul 15, 2016, 4:12:06 PM
    Author     : Rowdy
--%>
...
<br>
    ...
    <table border="4" style="Arial">
         ...
         Datahelper.connect();
            ...
            <tr style="height: 40px" > <td> <%= res.getString(1) %></td> <td> <%= res.getString(2) %></td> <td><%=  res.getString(3) %></td> <td><%=  res.getString(4) %></td><td><%=  res.getString(5) %></td><td><a href="editfees.jsp?q=<%= res.getInt(1)  %>&r=<%= res.getString(3) %>">EDIT</a>/<a href="deletefees.jsp?q=<%= res.getInt(1)  %>&r=<%= res.getString(3) %>">DELETE</a></td></tr>
