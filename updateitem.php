...
if(isset($_SESSION['username']))
    ...
    $_SESSION['item_code']=$ic;
    
    $qry="Select * from items where item_code=$ic";
                    ...
                    <div class="col-lg-7">
                          <section class="panel">
                              ...
                              <div class="panel-body">
                                  <form action="updateitem2.php" method="post" enctype="multipart/form-data" role="form"  >
                                     
                                       <div class="form-group">
                                          <label for="exampleInputText1">Item Code</label>
                                          <input type="text" name="txtid" class="form-control" id="exampleInputText11" placeholder="Item Code" value=<?php echo "$row[0]";  ?>  />
                                      </div>
                                      
                                      <div class="form-group">
                                          <label for="exampleInputText1">Item Name</label>
                                          <input type="text" name="txtun" class="form-control" id="exampleInputText11" placeholder="Item Name" value=<?php echo "$row[1]";  ?>  />
                                      </div>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <input type="text" name="txtnumber" class="form-control" id="exampleInputText11" placeholder="Price" value=<?php echo "$row[2]";  ?> />
                                      </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <br />
                                          <img width='130px' height='100px' src='<?php echo "$row[3]"?>' />
                                      </div>
