...
$conn= @mysqli_connect($host,$user,$pass,$db) or die("Can't connect to database");
  ...
  $qry="SELECT * FROM `orders` order by order_code";
                             ...
                             <div class="panel-body table-responsive">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        while( $row=mysqli_fetch_row($rs))
                                        {
                                            ...
                                            {
                                              if($i==$count)
                                                echo "<td><form action='updateorder.php' > <input type='hidden' name='update' value='$row[0]' />   <input type='submit'  value='Update' class='active btn btn-info' /> </form></td>";

                                             else if($i==$count+1)
                                                echo "<td> <form action='deleteorder.php' > <input type='hidden' name='delete' value='$row[0]' />   <input type='submit'  value='Delete' class='active btn btn-info' /> </form></td>";
