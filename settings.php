                            ...
                            <div class="panel-body">
                                  <form>
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="txtun" class="form-control" id="exampleInputText11" placeholder="Enter Username"  />
                                      </div>
                                      
                                      <div class="form-group">
                                          <label for="exampleInputPassword1">Password</label>
                                          <input type="password" name="pwd" class="form-control" id="exampleInputText1" placeholder="Password"  />
                                      </div>
                                      
                                      <div  class="form-group">
                                      <label for="exampleInputText1">Address</label>
                                      <textarea style="height:150px ;  resize: vertical;  " name="txta" class="form-control" id="exampleInputText1" placeholder="Eneter Address"  ></textarea>
                                      </div>
                                      
                                      <div class="form-group">
                                          <label for="exampleInputText1">Contact Number</label>
                                          <input type="text" name="txtc" class="form-control" id="exampleInputText1" placeholder="Enter Contact Number"  />
                                      </div>
...
if(isset($_GET['add']))
{
    ...
    $qry="INSERT INTO administrator(username, password, address, contact_no) VALUES ('$un','$p','$a','$c')";
